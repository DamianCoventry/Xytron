...
namespace
{
    const unsigned int DAMAGE_CAUSED = 2;
}

///////////////////////////////////////////////////////////////////////////////
LaserShotSmallEntity::LaserShotSmallEntity(IWorld* world)
: world_(world)
, speed_(850.0f)
{
}
...
///////////////////////////////////////////////////////////////////////////////
void LaserShotSmallEntity::BindResources(Util::ResourceContext* resources)
{
    img_            = resources->FindImage("Images/LaserShotSmall.tga");
    snd_collide_    = resources->FindSound("Sounds/LaserHit.wav");
}

///////////////////////////////////////////////////////////////////////////////
void LaserShotSmallEntity::Think(float time_delta)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void LaserShotSmallEntity::Move(float time_delta)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void LaserShotSmallEntity::CollideWithEnemyEntities(Gfx::EntityList& entities)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void LaserShotSmallEntity::Draw2d(const Gfx::Graphics& g)
{
    if(Dead())
    {
        return;
