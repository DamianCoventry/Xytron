...
///////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDED_RAILSHOTEXPLOSIONENTITY
#define INCLUDED_RAILSHOTEXPLOSIONENTITY

#include "../gfx/gfx.h"
#include "../util/resourcecontext.h"

///////////////////////////////////////////////////////////////////////////////
class RailShotExplosionEntity
    : public Gfx::IEntity
{
public:
    RailShotExplosionEntity(const Math::Vector& position,
                            int num_sparks = 10,
...
#endif  // INCLUDED_RAILSHOTEXPLOSIONENTITY
