...
///////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDED_MISSILESHOTEXPLOSIONENTITY
#define INCLUDED_MISSILESHOTEXPLOSIONENTITY

#include "../gfx/gfx.h"
#include "../util/resourcecontext.h"

///////////////////////////////////////////////////////////////////////////////
class MissileShotExplosionEntity
    : public Gfx::IEntity
{
public:
    MissileShotExplosionEntity(const Math::Vector& position);
...
#endif  // INCLUDED_MISSILESHOTEXPLOSIONENTITY
