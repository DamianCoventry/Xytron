...
///////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDED_PLAYEREXPLOSIONENTITY
#define INCLUDED_PLAYEREXPLOSIONENTITY

#include "../gfx/gfx.h"
#include "../util/resourcecontext.h"

///////////////////////////////////////////////////////////////////////////////
class PlayerExplosionEntity
    : public Gfx::IEntity
{
public:
    PlayerExplosionEntity(const Math::Vector& position);
...
#endif  // INCLUDED_PLAYEREXPLOSIONENTITY
