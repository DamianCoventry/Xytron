...
///////////////////////////////////////////////////////////////////////////////
#ifndef INCLUDED_NUKEEXPLOSIONENTITY
#define INCLUDED_NUKEEXPLOSIONENTITY

#include "../gfx/gfx.h"
#include "../util/resourcecontext.h"

///////////////////////////////////////////////////////////////////////////////
class NukeExplosionEntity
    : public Gfx::IEntity
{
public:
    NukeExplosionEntity(const Math::Vector& position);
...
#endif  // INCLUDED_NUKEEXPLOSIONENTITY
