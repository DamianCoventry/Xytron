...
///////////////////////////////////////////////////////////////////////////////
BasicShotExplosionEntity::BasicShotExplosionEntity(const Math::Vector& position,
                                                   int num_sparks,
                                                   int min_r, int max_r,
                                                   int min_g, int max_g,
                                                   int min_b, int max_b)
...
///////////////////////////////////////////////////////////////////////////////
void BasicShotExplosionEntity::Think(float time_delta)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void BasicShotExplosionEntity::Move(float time_delta)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void BasicShotExplosionEntity::Draw2d(const Gfx::Graphics& g)
{
    if(Dead())
    {
        return;
