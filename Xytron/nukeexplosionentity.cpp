...
///////////////////////////////////////////////////////////////////////////////
NukeExplosionEntity::NukeExplosionEntity(const Math::Vector& position)
...
///////////////////////////////////////////////////////////////////////////////
void NukeExplosionEntity::BindResources(Util::ResourceContext* resources)
{
    central_flash_.image_   = resources->FindImage("Images/NukeExplosion.tga");
    wake_.image_            = resources->FindImage("Images/NukeWake.tga");
...
///////////////////////////////////////////////////////////////////////////////
void NukeExplosionEntity::Think(float time_delta)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void NukeExplosionEntity::Move(float time_delta)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void NukeExplosionEntity::Draw2d(const Gfx::Graphics& g)
{
    if(Dead())
    {
        return;
