...
namespace
{
    ...
    const float PRE_FADE_THRESHOLD  = 0.1f;
}

///////////////////////////////////////////////////////////////////////////////
PlayerExplosionEntity::PlayerExplosionEntity(const Math::Vector& position)
...
///////////////////////////////////////////////////////////////////////////////
void PlayerExplosionEntity::BindResources(Util::ResourceContext* resources)
{
    ...
    debris_[0].imgani_ = resources->FindImageAnim("Images/PlayerShip_P0.tga");
    debris_[1].imgani_ = resources->FindImageAnim("Images/PlayerShip_P1.tga");
    debris_[2].imgani_ = resources->FindImageAnim("Images/PlayerShip_P2.tga");
    debris_[3].imgani_ = resources->FindImageAnim("Images/PlayerShip_P3.tga");
...
///////////////////////////////////////////////////////////////////////////////
void PlayerExplosionEntity::Think(float time_delta)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void PlayerExplosionEntity::Move(float time_delta)
{
    if(Dead())
    {
        return;
...
///////////////////////////////////////////////////////////////////////////////
void PlayerExplosionEntity::Draw2d(const Gfx::Graphics& g)
{
    if(Dead())
    {
        return;
